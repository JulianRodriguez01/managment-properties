...
<%@ page
	import="java.util.ArrayList, edu.uptc.entity.Person, edu.uptc.model.Manager, edu.uptc.entity.Obligation"%>
<div id="layoutSidenav_content">
	<main>
		<form action="obligations.jsp" method="post">
			<div class="container-fluid px-4">
				<h1 class="mt-4">Obligaciones</h1>
				<ol class="breadcrumb mb-4">
					<li class="breadcrumb-item"><a href="index.jsp">Obligaciones</a></li>
					<li class="breadcrumb-item active">Inicio</li>
				</ol>
				<div class="card mb-4">
					<div class="card-body">A continuación ingrese el usuario para
						verificar las obligaciones.</div>
				</div>
				<div class="card mb-4">
					<div class="card-header">
						<i class="fas fa-chart-area me-1"></i> Obligaciones
					</div>
					<div class="card-body">
					...
					<select name="select_id" class="form-select form-select-sm"
						...
						try {
							...
							if (lista != null) {
						%>
						<option selected value=0>Selecciones los datos del usuario que
							desee consultar.</option>
						<%
						for (Person e : lista) {
						%>
						...
						<tbody>
							<tr>
								...
								if (request.getParameter("select_id") != null) {
									ArrayList<Obligation> listaObligation = manager
									.uploadObligation(Integer.parseInt(request.getParameter("select_id")));
									if (lista.size() > 0) {
										for (Obligation o : listaObligation) {
									String id = (o.getIdObligation()) != 0 ? String.valueOf(o.getIdObligation()) : "---";
									String description = (o.getdescription()) != null ? o.getdescription() : "---";
								%>
								<th scope=row><%=id%></th>
								<td><%=description%></td>
								<td><input type="submit" name="delete_user"
									value="<%=o.getIdObligation()%>"
