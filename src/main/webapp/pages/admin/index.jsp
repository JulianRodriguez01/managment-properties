	...
	<div id="layoutSidenav_content">
		<main>
			<div class="container-fluid px-12">
				...
				<div class="card mb-4">
					<div class="card-body">Bienvenido ${person.name} a la administración de propiedades horizontales! Es un gusto tenerte.</div>
				</div>
				<img src="../../images/admi-pro.jpg" class="img-fluid"
